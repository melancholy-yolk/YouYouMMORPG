...
public class ProtoCodeDef
{
    ...
    /// 测试协议
    /// </summary>
    public const ushort Test = 17001;

    /// <summary>
    /// 获取邮件详情
    /// </summary>
    public const ushort Mail_Get_Detail = 17002;

    /// <summary>
    /// 获取物品列表
    /// </summary>
    public const ushort Get_Item_List = 17003;

    /// <summary>
    /// 请求邮件列表
    /// </summary>
    public const ushort Mail_Request_List = 17004;
